...
- [ ] Create a project structure (routes, controllers, middleware, etc.)
- [ ] Set up logging using Winston or similar
...
- [ ] Create JSON files with mock data for memory items by category (10 items)
- [ ] Implement routes for fetching all memory items
- [ ] Add routes for fetching items by category
- [ ] Implement search endpoint with filtering by name/description
- [ ] Create mock user profiles and authentication responses
